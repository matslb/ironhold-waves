...
export const helpClassGuide = [
  ...
  {
    character: "sentinel",
    tagline: "Crownford wall-guard with a long halberd. No block, dodge, or heals - hold the swarm at spear's length with reach, sweeps, and shoving control, and watch your Vigor.",
    abilities: [
      { id: "thrust", keys: "LMB / Space", note: "free long-reach jab; narrow, so line your point up." },
      { id: "shove", keys: "RMB / K", note: "wide haft push that staggers and makes space - your survival tool." },
      { id: "moulinet", keys: "MMB / J", note: "full-circle cut around you; the answer to being surrounded." },
      { id: "hook", keys: "F", note: "hooks the nearest enemy along your spear-line and drags it onto your point, briefly stunned." },
      { id: "skewer", keys: "C" }
    ]
  }
];
...
const helpTuningLabels = {
  ...
  thrustRange: "Thrust reach",
  thrustDamageMin: "Thrust base damage",
  thrustDamageSpread: "Thrust damage spread",
  thrustDamageBonus: "Thrust damage bonus",
  thrustKnockback: "Thrust knockback",
  shoveVigorCost: "Haft Shove vigor cost",
  shoveDamageMin: "Haft Shove base damage",
  shoveDamageSpread: "Haft Shove damage spread",
  shoveStun: "Haft Shove stagger",
  shoveVelocity: "Haft Shove push",
  moulinetVigorCost: "Moulinet vigor cost",
  moulinetRadius: "Moulinet radius",
  moulinetDamageMin: "Moulinet base damage",
  moulinetDamageSpread: "Moulinet damage spread",
  moulinetCooldown: "Moulinet cooldown",
  hookVigorCost: "Billhook Pull vigor cost",
  hookCooldown: "Billhook Pull cooldown",
  hookRange: "Billhook Pull reach",
  hookDamageMin: "Billhook Pull base damage",
  hookDamageSpread: "Billhook Pull damage spread",
  hookStun: "Billhook Pull stun",
  hookPull: "Billhook Pull drag",
  skewerVigorCost: "Skewer Charge vigor cost",
  skewerCooldown: "Skewer Charge cooldown",
  skewerRange: "Skewer Charge reach",
  skewerDamageMin: "Skewer Charge base damage",
  skewerDamageSpread: "Skewer Charge damage spread",
...
export const helpSourceLabels = {
  ...
  sentinel_ironshod_halberd: "starting kit",
  sentinel_crownring_partisan: "First Bell of the Crownring",
...
export const helpPermanentRewardItems = [
  ...
  { label: "The Skyhatched Brood", text: "Skyhatched Drake mount - hovers over the ground and rides faster than a horse - and XP." },
  { label: "The Well-Road Courser", text: "Dune Courser mount - a swift desert strider quicker than an untacked horse - and XP." },
